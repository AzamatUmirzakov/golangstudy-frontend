  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gray-50">
      <div className="bg-white rounded-lg w-[400px] p-8 shadow-lg">
        <h1 className="text-gray-900 text-4xl text-center mb-6 font-bold">Register</h1>
        ...
        <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col items-center mt-4 gap-2">
            <button type="submit" className="bg-blue-600 rounded-lg text-lg h-10 w-full cursor-pointer text-white font-medium hover:bg-blue-700">Register</button>
            <Link to="/login" className="text-blue-600 text-sm text-center mt-2 hover:underline font-medium">Login</Link>
          </div>
        </form>
      </div>
    </div>
