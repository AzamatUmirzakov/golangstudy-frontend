  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <div className="bg-[#16161a] rounded-md w-[400px] p-6">
        <h1 className="text-white text-4xl text-center mb-5">Register</h1>
        ...
        <form className="flex flex-col gap-4 text-white" onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col items-center mt-4 gap-2">
            <button type="submit" className="bg-blue-500 rounded-md text-lg h-10 w-full cursor-pointer text-white">Register</button>
            <Link to="/login" className="text-blue-400 text-sm text-center mt-2 hover:underline">Login</Link>
          </div>
        </form>
      </div>
    </div>
