    ...
    <div className="flex h-screen w-screen">
      <div className="bg-white border-r border-gray-200 p-4 w-64 overflow-y-auto">
        ...
        <div className="gap-2 flex flex-col">
          ...
          <Link className={linkClasses("/students")} to="/students">Students</Link>
          <Link className={linkClasses("/courses")} to="/courses">Courses</Link>
          <Link className={linkClasses("/instructors")} to="/instructors">Instructors</Link>
        </div>
      </div>
